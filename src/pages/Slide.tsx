...
function Slide() {
    ...
    useGSAP(() => {
        const eles = gsap.utils.toArray("#slide-page-techs > .list-ele");
        eles.forEach(ele => {
    ...
    return (
        <div id="slide-page">
            ...
            <ul id="slide-page-techs">
                ...
                <ListElement name="Swiper.js" url="https://swiperjs.com/">
                    <img src="https://swiperjs.com/images/swiper-logo.svg" alt="swiper.js" />
                </ListElement>
                <ListElement name="GSAP" url="https://gsap.com/">
                ...
                <ListElement name="ReactRouter" url="https://reactrouter.com/">
                    <img src="https://reactrouter.com/_brand/react-router-stacked-color.svg" alt="react router" />
                </ListElement>
            </ul>
        </div>
    );
